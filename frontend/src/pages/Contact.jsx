    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-center items-start gap-6'>
          ...
          <p className='text-gray-500'>Address <br /> KZ</p>
          <p className='text-gray-500'>Tel: 123456468979 <br />a@a.com</p>
          <p className='font-semibold text-xl text-gray-600'>Careers at HurryScurry</p>
